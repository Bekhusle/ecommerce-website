...
<html lang="en">
	<head>
	    ...
	    <title>Бүтээгдэхүүний ангилал</title>
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Дэд ангилал</div>        
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">дэлгүүр</h3>
	            	<div class="sidebar-filter">
		            	<!-- ============================================== SIDEBAR CATEGORY ============================================== -->
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title">Ангилал</h4>
	</div>
...
{?>							
	...
	<div class="product">		
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>Бүтээгдэхүүн олдсонгүй</h3>
		</div>
