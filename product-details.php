...
<html lang="en">
	<head>
	    ...
	    <title>Бүтээгдэхүүний дэлгэрэнгүй мэдээлэл</title>
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Ангилал</h3>
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">халуун хямдрал</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									₮. <?php echo htmlentities($rws['productPrice']);?>.000
								</span>
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Сагсанд нэмэх</button></a>
								<?php } else {?>
							<div class="action" style="color:red">Зарагдаж дууссан</div>
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> санал хүсэлт)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Бэлэн байдал :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box"> 
											<span class="value" style="margin-left:10px"> <?php echo htmlentities($row['productAvailability']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Бүтээгдэхүүний брэнд:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value" style="margin-left:90px"><?php echo htmlentities($row['productCompany']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Хүргэлтийн хураамж:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value" style="margin-left:75px"><?php if($row['shippingCharge']==0)
											{
												echo "Free";
											}
											else
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Сагсанд нэмэх</a>
													<?php } else {?>
							<div class="action" style="color:red">Зарагдаж дууссан</div>
					<?php } ?>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label">Хуваалцах:</span>
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="http://facebook.com/vici onlineshop"></a></li>
						                <li><a class="fa fa-instagram" href="http://instagram.com/vici__onlineshop"></a></li>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">ТОДОРХОЙЛОЛТ</a></li>
								<li><a data-toggle="tab" href="#review">санал хүсэлт</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Хэрэглэгчийн санал хүсэлт</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Чанартай :</b>  <?php echo htmlentities($rvw['quality']);?> </div>
													<div class="text"><b>Үнэ :</b>  <?php echo htmlentities($rvw['price']);?> </div>
													<div class="text"><b>үнэ цэнэ :</b>  <?php echo htmlentities($rvw['value']);?> </div>
										...
										<div class="product-add-review">
											<h4 class="title">Өөрийнхөө сэтгэгдлийг бичээрэй</h4>
											<div class="review-table">
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															<tr>
																<td class="cell-label">Чанартай</td>
															...
															<tr>
																<td class="cell-label">Үнэ цэнэ</td>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">Таны нэр <span class="astk">*</span></label>
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="" name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary">Дүгнэлт <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Санал хүсэлт <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper"> ИЛГЭЭХ</button>
														</div><!-- /.action -->
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Үл хөдлөх бүтээгдэхүүн </h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Сагсанд нэмэх</a>
