	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Дэлгүүрийн карт</li>
			</ul>
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Устгах</th>
					<th class="cart-description item">Зураг</th>
					<th class="cart-product-name item">Бүтээгдэхүүний нэр</th>
			
					<th class="cart-qty item">Тоо хэмжээ</th>
					<th class="cart-sub-total item">Нэгж үнэ</th>
					<th class="cart-sub-total item">Хүргэлтийн хураамж</th>
					<th class="cart-total last-item"> нийт</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<!-- <a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Худалдан авалтыг үргэлжлүүлэх</a> -->
								<input type="submit" name="submit" value="Худалдааны сагсыг шинэчлэх" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> Санал хүсэлт )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Хүргэлтийн хаяг</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Хүргэлтийн хаяг/дэлгэрэнгүй/<span></span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Хот  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Аймаг/Дүүрэг <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Zip пин код <span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Шинэчлэх</button>
...
<!-- <div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Тооцооны хаяг</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Хүргэлтийн хаяг<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Хүргэлтийн пин код <span>*</span></label>
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Шинэчлэх</button>
					<?php } ?>
		...
		<thead>
			<tr>
				<th>
					...
					Нийт<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Худалдан авалт</button>
