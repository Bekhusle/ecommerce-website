...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">Надад таалагдсан</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> санал хүсэлт )</span>
						</div>
						<?php } ?>
						<div class="price">₮. 
					...
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Сагсанд нэмэх</a>
					</td>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Танд таалагдсан бараа байхгүй байна</td>
