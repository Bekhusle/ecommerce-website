...
<html lang="en">
	<head>
	    ...
	    <title>Хүлээгдэж буй захиалгын түүх</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Дэлгүүрийн сагс</li>
			</ul>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total">Нийт</th>
					<th class="cart-total item">Төлбөрийн нөхцөл</th>
					<th class="cart-description item">Захиалгын огноо</th>
					<th class="cart-total last-item">Үйлдэл</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Устгах</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Үр дүн олдсонгүй</h4></td>
</tr>
<?php } ?>
