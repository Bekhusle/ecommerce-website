...
<html lang="en">
	<head>
	    ...
	    <title>Vici onlineshop нүүр хуудас</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" 
			style="background-image: url(assets/images/sliders/slider.jpg);">
			<iframe width="853" height="480" src="https://www.youtube.com/embed/y5Cm8b4pN-s?autoplay=1&mute=1" title="The Dior Men&#39;s Summer 2022 Campaign Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
		...
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/slider.jpg);">
			</div><!-- /.item -->
		</div><
	</div><!-- /.owl-carousel -->
</div>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">мөнгө буцаах</h4>
						</div>
					</div>	
					<h6 class="text">30 хоногт мөнгө буцааж өгөх баталгаа.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">үнэгүй хүргэлт</h4>
						</div>
					</div>
					<h6 class="text">10.000₮-ээс дээш үнэ төлбөргүй хүргэнэ.</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Тусгай хямдрал</h4>
						</div>
					</div>
					<h6 class="text">Бүх бараа -10-20% хүртэл хямдралтай </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Онцлох бүтээгдэхүүн</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Бүгд</a></li>
					<li><a href="#books" data-toggle="tab">Пүүз</a></li>
					<li><a href="#furniture" data-toggle="tab">Нарны шил</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Сагсанд нэмэх</a></div>
				<?php } else {?>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Хувцас</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Гоёл чимэглэл</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
