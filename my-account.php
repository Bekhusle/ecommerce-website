...
<div class="form-group">
					    <label class="info-title" for="name">Нэр<span>*</span></label>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Холбоо барих дугаар<span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">Одоогийн Нууц Үг<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">Шинэ нууц үг <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Нууц үгээ баталгаажуулна уу <span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Өөрчлөх </button>
					</form> 
